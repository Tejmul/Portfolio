      ...
      >
       Tejmul Movin
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
          Student at NST | Freelancer | Web Developer | National Football Player | Content Creator
        </p>
       <div className="mt-4" style={{ display: 'flex',alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
            <Link href="https://github.com/Tejmul" target="_blank">
                <Button
                  borderRadius="50%"
            ...
            <Link href="https://www.instagram.com/tejmul_nst/" target="_blank">
                <Button
                  borderRadius="50%"
                  className="bg-white dark:bg-black text-black dark:text-white border-neutral-200 dark:border-slate-800"
                >
            ...
            <Link href="https://www.linkedin.com/in/tejmul-movin-040387275/" target="_blank">
                <Button
                  borderRadius="50%"
                  className="bg-white dark:bg-black text-black dark:text-white border-neutral-200 dark:border-slate-800"
                >
            ...
            <Link href="mailto:tejmulmovin@gmail.com" target="_blank">
                <Button
                  borderRadius="50%"
                  className="bg-white dark:bg-black text-black dark:text-white border-neutral-200 dark:border-slate-800"
                >
